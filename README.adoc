...
image:https://github.com/mihxil/json-source-annotation/actions/workflows/maven.yml/badge.svg?[Build Status,link=https://github.com/mihxil/json-source-annotation/actions/workflows/maven.yml]
image:https://codecov.io/gh/mihxil/json-source-annotation/branch/main/graph/badge.svg[codecov,link=https://codecov.io/gh/mihxil/json-source-annotation]
